...
module Bundler
  ...
  SPECS        = [
        {:loaded_from=>"/Users/geemus/.bundle/ruby/1.8/specifications/rake-0.8.7.gemspec", :name=>"rake", :load_paths=>["/Users/geemus/.bundle/ruby/1.8/gems/rake-0.8.7/lib"]},
        {:loaded_from=>"/Library/Ruby/Gems/1.8/specifications/formatador-0.0.14.gemspec", :name=>"formatador", :load_paths=>["/Library/Ruby/Gems/1.8/gems/formatador-0.0.14/lib"]},
        {:loaded_from=>"/Library/Ruby/Gems/1.8/specifications/gestalt-0.0.6.gemspec", :name=>"gestalt", :load_paths=>["/Library/Ruby/Gems/1.8/gems/gestalt-0.0.6/lib"]},
      ].map do |hash|
